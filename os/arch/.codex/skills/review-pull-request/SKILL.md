...
/home/tamakiii/.dotfiles/os/arch/.codex/bin/gh pr view <N> --repo <repo> --json title,body,headRefName,baseRefName,state,additions,deletions,files,commits
/home/tamakiii/.dotfiles/os/arch/.codex/bin/gh pr diff <N> --repo <repo>
/home/tamakiii/.dotfiles/os/arch/.codex/bin/gh api repos/<repo>/pulls/<N>/comments --jq '.[].body'
/home/tamakiii/.dotfiles/os/arch/.codex/bin/gh api repos/<repo>/pulls/<N>/reviews --jq '.[] | {state: .state, body: .body}'
```
...
Always use `/home/tamakiii/.dotfiles/os/arch/.codex/bin/gh` so the review is posted as `tamakiii-codex[bot]`.
...
```bash
/home/tamakiii/.dotfiles/os/arch/.codex/bin/gh pr review <N> --repo <repo> --request-changes --body "$(cat <<'EOF'
## Review
